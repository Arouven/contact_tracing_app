                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label">Contact Distance (meters)</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="contactDistance" name="text-input" placeholder="2" class="form-control">
                                                    <small class="form-text text-muted">Distance that someone will be treated as contact with an infected.</small>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label">Test Validity (days)</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="daysOfTestValidity" name="text-input" placeholder="7" class="form-control">
                                                    <small class="form-text text-muted">Past these days, the test will be invalid.</small>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label">Incubation Time (days)</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="daysFromContact" name="text-input" placeholder="14" class="form-control">
