...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $selectquery = "SELECT email FROM User WHERE username = ?;";
    ...
    if (isset($data) && $data != null) { //if there is something in the result
        ...
        $ed = new encryptDecrypt($username);
        ...
        mail($username, $to_email, $subject, $message);
...
function mail($username, $to_email, $subject, $message)
{
    try {
        ...
        $mail->Username = "internetprogramming2019@gmail.com"; // Your Gmail address.
        ...
        $mail->addAddress($to_email, $username); // Set the recipient of the message.
        $mail->send();
